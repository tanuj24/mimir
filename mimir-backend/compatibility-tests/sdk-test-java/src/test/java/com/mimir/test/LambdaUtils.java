...
public final class LambdaUtils {
     ...
     * Used to verify Mimir's embedded DNS forwards public lookups from inside Lambda containers
     * (regression for https://github.com/mimir-local/mimir/issues/1110).
     */
