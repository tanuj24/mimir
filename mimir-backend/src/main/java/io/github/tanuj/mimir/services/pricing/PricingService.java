 ...
 * overridden at runtime by setting {@code mimir.services.pricing.snapshot-path}
 * (env: {@code MIMIR_SERVICES_PRICING_SNAPSHOT_PATH}) to a filesystem directory
...
public class PricingService {
    ...
    public ObjectNode getPriceListFileUrl(String priceListArn, String fileFormat) {
        ...
        ObjectNode response = objectMapper.createObjectNode();
        response.put("Url", "https://pricing-snapshot.mimir.local/"
