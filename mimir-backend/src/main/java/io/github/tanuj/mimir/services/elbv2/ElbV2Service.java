...
public class ElbV2Service {
     ...
     *  capacity is reserved, which is always the case in Mimir (capacity cannot be reserved). */
    ...
    public CapacityReservation describeCapacityReservation(String region, String arn) {
        ...
        // Mimir does not reserve load balancer capacity, so there is never a reservation to report.
