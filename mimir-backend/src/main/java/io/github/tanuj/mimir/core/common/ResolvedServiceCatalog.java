...
import io.github.tanuj.mimir.services.appconfig.AppConfigController;
import io.github.tanuj.mimir.services.backup.BackupController;
import io.github.tanuj.mimir.services.appconfig.AppConfigDataController;
import io.github.tanuj.mimir.services.bedrockruntime.BedrockRuntimeController;
import io.github.tanuj.mimir.services.cognito.CognitoOAuthController;
import io.github.tanuj.mimir.services.cognito.CognitoWellKnownController;
import io.github.tanuj.mimir.services.eks.EksController;
import io.github.tanuj.mimir.services.pipes.PipesController;
import io.github.tanuj.mimir.services.lambda.LambdaController;
import io.github.tanuj.mimir.services.opensearch.OpenSearchController;
import io.github.tanuj.mimir.services.cloudfront.CloudFrontController;
import io.github.tanuj.mimir.services.route53.Route53Controller;
import io.github.tanuj.mimir.services.ses.SesController;
import io.github.tanuj.mimir.services.appsync.AppSyncController;
    ...
    public ResolvedServiceCatalog(EmulatorConfig config) {
        this.catalog = new ServiceCatalog(List.of(
                ...
                descriptor("kafka", "msk", config.services().msk().enabled(), true,
                        ...
                        protocols(ServiceProtocol.REST_JSON),
                        Set.of(), Set.of("kafka"), Set.of(), Set.of(io.github.tanuj.mimir.services.msk.MskController.class)),
