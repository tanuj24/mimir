package io.github.tanuj.mimir.services.transcribe;

import io.github.tanuj.mimir.core.common.AwsException;
import io.github.tanuj.mimir.services.transcribe.model.TranscriptionJob;
import io.github.tanuj.mimir.services.transcribe.model.TranscriptionJobSummary;
import io.github.tanuj.mimir.services.transcribe.model.VocabularyInfo;
...
public class TranscribeService {
    ...
    public TranscriptionJob startTranscriptionJob(String jobName, String mediaFileUri,
        ...
        TranscriptionJob job = new TranscriptionJob(
                ...
                new TranscriptionJob.Transcript("s3://mimir-transcribe-output/" + jobName + ".json"),
                now, now, now);
