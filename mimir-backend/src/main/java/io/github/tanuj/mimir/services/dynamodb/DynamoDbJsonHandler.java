...
import io.github.tanuj.mimir.core.common.AwsJsonController;
import io.github.tanuj.mimir.services.dynamodb.model.*;
import io.github.tanuj.mimir.services.kinesis.KinesisService;
import io.github.tanuj.mimir.services.dynamodb.TransactionCanceledException;
...
public class DynamoDbJsonHandler {
    ...
    private Response handleExportTable(JsonNode request, String region) {
        ...
        io.github.tanuj.mimir.services.dynamodb.model.ExportDescription desc =
    ...
    private Response handleListExports(JsonNode request, String region) {
        ...
        for (io.github.tanuj.mimir.services.dynamodb.model.ExportSummary s : result.exportSummaries()) {
