package io.github.tanuj.mimir.services.ce.enumerator;
...
/**
 * Emits zero-quantity placeholder lines for Mimir services that don't have
...
public class UnpricedServicesEnumerator implements ResourceUsageEnumerator {
    ...
    /**
     * AWS Price List service codes for the Mimir services Mimir's pricing snapshot
