...
class SesV2IntegrationTest {
    ...
    void createEmailIdentity_withTags_visibleViaGetAndListTags() {
        ...
        given()
            ...
            .body("""
                {
                    "EmailIdentity": "v2-tag-roundtrip.mimir.test",
                    "Tags": [
        ...
        given()
            .header("Authorization", AUTH_HEADER)
        .when()
            .get("/v2/email/identities/v2-tag-roundtrip.mimir.test")
        .then()
            .statusCode(200)
            .body("Tags", hasSize(2))
        ...
        String arn = "arn:aws:ses:us-east-1:000000000000:identity/v2-tag-roundtrip.mimir.test";
        given()
            .header("Authorization", AUTH_HEADER)
