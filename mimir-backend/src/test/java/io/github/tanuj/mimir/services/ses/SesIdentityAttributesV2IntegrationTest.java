...
class SesIdentityAttributesV2IntegrationTest {
    ...
    void createEmailIdentity_setsUpDomain() {
        given()
            ...
            .body("""
                {"EmailIdentity": "v2-attrs.mimir.test"}
                """)
        .when()
    ...
    void putEmailIdentityMailFromAttributes_setsDomain() {
        given()
            ...
            .body("""
                {
                  "MailFromDomain": "mail.v2-attrs.mimir.test",
                  "BehaviorOnMxFailure": "REJECT_MESSAGE"
                }
                """)
        .when()
            .put("/v2/email/identities/v2-attrs.mimir.test/mail-from")
        .then()
            .statusCode(200);
    }
    ...
    void getEmailIdentity_includesMailFromAttributes() {
        given()
            .header("Authorization", AUTH_HEADER)
        .when()
            .get("/v2/email/identities/v2-attrs.mimir.test")
        .then()
            .statusCode(200)
            .body("MailFromAttributes.MailFromDomain", equalTo("mail.v2-attrs.mimir.test"))
    ...
    void putEmailIdentityMailFromAttributes_unknownIdentity_returnsBadRequest() {
        given()
            ...
            .header("Authorization", AUTH_HEADER)
            .body("""
                {"MailFromDomain": "mail.ghost.mimir.test"}
                """)
        .when()
            .put("/v2/email/identities/ghost.mimir.test/mail-from")
        .then()
            .statusCode(400)
            .body("__type", equalTo("BadRequestException"))
            .body("message", equalTo("Identity <ghost.mimir.test> does not exist."));
    }
    ...
    void putEmailIdentityFeedbackAttributes_unknownIdentity_returnsBadRequest() {
        given()
            ...
            .body("""
                ...
                """)
        .when()
            .put("/v2/email/identities/ghost-feedback.mimir.test/feedback")
        .then()
            .statusCode(400)
            .body("__type", equalTo("BadRequestException"))
            .body("message", equalTo(
                    "Identity ghost-feedback.mimir.test is invalid. Must be a verified email address or domain."));
    }
    ...
    void putEmailIdentityDkimAttributes_unknownIdentity_returnsBadRequest() {
        given()
            ...
            .body("""
                ...
                """)
        .when()
            .put("/v2/email/identities/ghost-dkim.mimir.test/dkim")
        .then()
            .statusCode(400)
            .body("__type", equalTo("BadRequestException"))
            .body("message", equalTo(
                    "Domain ghost-dkim.mimir.test is not verified for DKIM signing."));
    }
    ...
    void putEmailIdentityDkimAttributes_emailFormatWithUnregisteredParent_returnsBadRequest() {
        ...
        given()
            ...
            .body("""
                ...
                """)
        .when()
            .put("/v2/email/identities/orphan@no-such-parent.mimir.test/dkim")
        .then()
            .statusCode(400)
            .body("__type", equalTo("BadRequestException"))
            .body("message", equalTo(
                    "Domain no-such-parent.mimir.test is not verified for DKIM signing."));
    }
    ...
    void putEmailIdentityDkimAttributes_emailWithRegisteredParentDomain_returnsNoOp() {
        ...
        given()
            ...
            .body("""
                ...
                """)
        .when()
            .put("/v2/email/identities/orphan@v2-attrs.mimir.test/dkim")
        .then()
            .statusCode(200);
        ...
        given()
            ...
            .header("Authorization", AUTH_HEADER)
        .when()
            .get("/v2/email/identities/orphan@v2-attrs.mimir.test")
        .then()
            .statusCode(404);
    }
    ...
    void createEmailIdentity_duplicate_returnsAlreadyExists() {
        ...
        .then()
            ...
            .body("message", equalTo(
                    "Email identity v2-attrs.mimir.test already exist."));
    }
    ...
    void deleteEmailIdentity_unknownIdentity_returnsNotFound() {
        given()
            ...
            .header("Authorization", AUTH_HEADER)
        .when()
            .delete("/v2/email/identities/ghost-delete.mimir.test")
        .then()
            .statusCode(404)
            .body("__type", equalTo("NotFoundException"))
            .body("message", equalTo(
                    "Email identity ghost-delete.mimir.test does not exist."));
    }
}
