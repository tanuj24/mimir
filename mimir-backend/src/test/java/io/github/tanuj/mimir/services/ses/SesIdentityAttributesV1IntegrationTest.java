...
class SesIdentityAttributesV1IntegrationTest {
    ...
    void verifyDomainIdentity_setsUpDomain() {
        given()
            ...
            .formParam("Domain", "v1-attrs.mimir.test")
        .when()
            .post("/")
        .then()
            .statusCode(200)
    ...
    void setIdentityMailFromDomain_setsAttributes() {
        given()
            ...
            .formParam("Identity", "v1-attrs.mimir.test")
            .formParam("MailFromDomain", "mail.v1-attrs.mimir.test")
    ...
    void getIdentityMailFromDomainAttributes_returnsValues() {
        given()
            ...
            .formParam("Identities.member.1", "v1-attrs.mimir.test")
        .when()
            .post("/")
        .then()
            .statusCode(200)
            .body(containsString("<MailFromDomain>mail.v1-attrs.mimir.test</MailFromDomain>"))
    ...
    void setIdentityMailFromDomain_unknownIdentity_returnsInvalidParameterValue() {
        given()
            ...
            .header("Authorization", AUTH)
            .formParam("Action", "SetIdentityMailFromDomain")
            .formParam("Identity", "ghost.mimir.test")
            .formParam("MailFromDomain", "mail.ghost.mimir.test")
        .when()
            .post("/")
        .then()
            .statusCode(400)
            .body(containsString("<Code>InvalidParameterValue</Code>"))
            .body(containsString("Identity &lt;ghost.mimir.test&gt; does not exist."));
    }
    ...
    void setIdentityHeadersInNotificationsEnabled_unknownIdentity_returnsInvalidParameterValue() {
        given()
            ...
            .header("Authorization", AUTH)
            .formParam("Action", "SetIdentityHeadersInNotificationsEnabled")
            .formParam("Identity", "ghost-headers.mimir.test")
            .formParam("NotificationType", "Bounce")
            .formParam("Enabled", "true")
        .when()
            .post("/")
        .then()
            .statusCode(400)
            .body(containsString("<Code>InvalidParameterValue</Code>"))
            .body(containsString("Identity ghost-headers.mimir.test is invalid. It must be a verified email address or domain."));
    }
    ...
    void setIdentityFeedbackForwardingEnabled_unknownIdentity_returnsInvalidParameterValue() {
        given()
            ...
            .header("Authorization", AUTH)
            .formParam("Action", "SetIdentityFeedbackForwardingEnabled")
            .formParam("Identity", "ghost-feedback.mimir.test")
        ...
        .then()
            .statusCode(400)
            .body(containsString("<Code>InvalidParameterValue</Code>"))
            .body(containsString("Identity ghost-feedback.mimir.test is invalid. Must be a verified email address or domain."));
    }
