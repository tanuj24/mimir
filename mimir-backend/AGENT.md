Guidance for AI coding agents working in the Mimir repository.
...
Mimir is a Java-based local AWS emulator built on Quarkus.
...
Mimir acts as an open-source alternative to LocalStack Community.
...
- Keep behavior aligned with AWS expectations and existing Mimir conventions
...
- `io.github.tanuj.mimir.config`
- `io.github.tanuj.mimir.core.common`
- `io.github.tanuj.mimir.core.storage`
- `io.github.tanuj.mimir.lifecycle`
- `io.github.tanuj.mimir.services.<service>`
...
Mimir must implement real AWS wire protocols.
...
Configuration lives under `mimir.*`.
...
5. Follow `MIMIR_*` environment variable conventions
