...
Mimir supports AWS AppConfig and AppConfigData for local configuration management.
...
|---|---|---|
| `MIMIR_SERVICES_APPCONFIG_ENABLED` | `true` | Enable or disable the AppConfig management plane |
| `MIMIR_SERVICES_APPCONFIGDATA_ENABLED` | `true` | Enable or disable the AppConfigData retrieval plane |
