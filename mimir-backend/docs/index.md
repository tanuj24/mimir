...
<p align="center">
  <img src="assets/mimir.svg" alt="Mimir" width="500" />
</p>

<p align="center"><em>Local AWS with a memory for your workflows</em></p>

---

Mimir is a fast, free, and open-source local AWS service emulator built for developers who need reliable AWS services in development and CI without cost, complexity, or vendor lock-in.

## Supported Services

Mimir emulates 51 AWS services. See the [Services Overview](services/index.md) for per-service operation counts, endpoints, and full protocol details.
